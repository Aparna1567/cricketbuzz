...
function Avatar({ name, imgUrl, size = 'default' }) {
  ...
  return (
    <div 
      className={playerListStyles.avatarFallback}
      style={avatarStyle}
    >
      {initials}
    </div>
...
export default function PlayerList({ players = [], onSelect, compact = false }) {
